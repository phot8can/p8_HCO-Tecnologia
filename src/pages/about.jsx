  ...
  return (
    <>
      <div className="relative isolate  pb-16 md:pb-20">
        ...
        {/* Info Section */}
        <section
          className="relative z-10 pt-24 md:pt-40 max-w-7xl mx-auto"
          data-aos="fade-up"
        >
      ...
      <section
        className="py-12 sm:py-16 md:py-20 px-4 sm:px-8 md:px-12 lg:px-16 max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-10 items-center"
        data-aos="fade-up"
      >
        <div
      ...
      <hr className="text-[#d6d6d6] mt-10" />
